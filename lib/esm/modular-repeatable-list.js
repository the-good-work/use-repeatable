...
function RepeatableList(_a) {
    ...
    return (React.createElement(Layout, { items: items, addItem: addItem, removeItem: removeItem, moveItem: moveItem, updateItem: updateItem, AddButton: function (_a) {
            ...
            return (React.createElement(AddButton, { onClick: onClick, children: children, addItem: addItem, index: index, newItem: newItem, length: items.length }));
            ...
            React.createElement(SortableContext, { items: items, strategy: verticalListSortingStrategy }, items.map(function (item, n) { return (React.createElement(SortableCard, { key: item.id, id: item.id, Card: Card, cardProps: {
                    ...
                    RemoveButton: function (_a) {
                        ...
                        return (React.createElement(RemoveButton, { onClick: onClick, children: children, removeItem: removeItem, index: index || n }));
                    },
                    MoveButton: function (_a) {
                        var onClick = _a.onClick, children = _a.children, direction = _a.direction;
                        return (React.createElement(MoveButton, { direction: direction, onClick: onClick, children: children, moveItem: moveItem, index: n, length: items.length }));
                    },
                } })); })))); } }));
}
