...
function RepeatableList(_a) {
    ...
    return (React.createElement(Layout, { addItem: addItem, Cards: function () { return (React.createElement(DndContext, { sensors: sensors, collisionDetection: closestCenter, onDragEnd: handleDragEnd },
...
function SortableCard(_a) {
    ...
    return (React.createElement("div", __assign({ ref: setNodeRef }, attributes, { style: { transform: CSS.Transform.toString(transform), transition: transition } }),
        React.createElement(Card, __assign({}, cardProps, { dragHandleListeners: listeners }))));
}
