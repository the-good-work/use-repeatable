...
var SortableCard = function (_a) {
    ...
    var _c = useSortable({ id: item.id }), attributes = _c.attributes, listeners = _c.listeners, setNodeRef = _c.setNodeRef, transform = _c.transform, transition = _c.transition;
