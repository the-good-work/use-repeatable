    ...
    return Layout({
        ...
        ClearButton: function (_a) {
            ...
            return (React.createElement("div", null,
                React.createElement(ClearButton, { removeAll: removeAll, children: children, className: className, onClick: onClick })));
        },
        Cards: Cards({
            sensors: sensors,
...
function Cards(_a) {
    ...
    return (React.createElement("div", { className: "repeatable-list__cards" },
...
var SortableCard = function (_a) {
    ...
    return (React.createElement("div", __assign({ className: "repeatable-list__card", ref: setNodeRef }, attributes, { style: { transform: CSS.Transform.toString(transform), transition: transition } }), Card(__assign(__assign({}, cardProps), { DragHandle: function (_a) {
