...
function RepeatableList(_a) {
    ...
    return Layout({
        ...
        AddButton: function (_a) {
            var index = _a.index, onClick = _a.onClick;
        ...
        ClearButton: function (_a) {
            ...
            return (react_1.default.createElement("div", null,
                react_1.default.createElement(ClearButton_1.ClearButton, { removeAll: removeAll, children: children, className: className, onClick: onClick })));
        },
        Cards: Cards({
            sensors: sensors,
            closestCenter: core_1.closestCenter,
            handleDragEnd: handleDragEnd,
            items: items,
            verticalListSortingStrategy: sortable_1.verticalListSortingStrategy,
            Card: Card,
            removeItem: removeItem,
            moveItem: moveItem,
            addItem: addItem,
...
function Cards(_a) {
    var sensors = _a.sensors, closestCenter = _a.closestCenter, handleDragEnd = _a.handleDragEnd, items = _a.items, verticalListSortingStrategy = _a.verticalListSortingStrategy, Card = _a.Card, removeItem = _a.removeItem, moveItem = _a.moveItem, addItem = _a.addItem, updateItem = _a.updateItem, removeAll = _a.removeAll;
    return (react_1.default.createElement("div", { className: "repeatable-list__cards" },
        react_1.default.createElement(core_1.DndContext, { sensors: sensors, collisionDetection: closestCenter, onDragEnd: handleDragEnd },
            react_1.default.createElement(sortable_1.SortableContext, { items: items, strategy: verticalListSortingStrategy }, items.map(function (item, n) { return (react_1.default.createElement(SortableCard, { key: item.id, id: item.id, Card: Card, cardProps: {
                    // Props
                    item: item,
                    items: items,
                    index: n,
...
var SortableCard = function (_a) {
    ...
    return (react_1.default.createElement("div", __assign({ className: "repeatable-list__card", ref: setNodeRef }, attributes, { style: { transform: utilities_1.CSS.Transform.toString(transform), transition: transition } }), Card(__assign(__assign({}, cardProps), { DragHandle: function (_a) {
