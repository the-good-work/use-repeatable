...
var RepeatableList = function (props) {
    ...
    return (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement("button", { style: __assign(__assign({}, defaultAddItemButtonStyles), addItemButtonStyles), onClick: function () {
                addItem();
            } }, "Add Item")));
};
...
var SortableCard = function (_a) {
    ...
    var _b = (0, sortable_1.useSortable)({ id: item.id }), attributes = _b.attributes, listeners = _b.listeners, setNodeRef = _b.setNodeRef, transform = _b.transform, transition = _b.transition;
