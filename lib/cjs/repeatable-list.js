...
function RepeatableList(_a) {
    ...
    return (react_1.default.createElement("div", { className: "repeatable-list__wrapper" },
        react_1.default.createElement(Layout, { items: items, addItem: addItem, removeItem: removeItem, moveItem: moveItem, updateItem: updateItem, removeAll: removeAll, AddButton: function (_a) {
                var onClick = _a.onClick, children = _a.children, index = _a.index, newItem = _a.newItem, className = _a.className;
                return (react_1.default.createElement(AddButton_1.AddButton, { onClick: onClick, children: children, addItem: addItem, index: index, newItem: newItem, length: items.length, className: className }));
...
function SortableCard(_a) {
    ...
    return (react_1.default.createElement("div", __assign({ className: "repeatable-list__card", ref: setNodeRef }, attributes, { style: { transform: utilities_1.CSS.Transform.toString(transform), transition: transition } }),
        react_1.default.createElement(Card, __assign({}, cardProps, { DragHandle: function (_a) {
                ...
                return (react_1.default.createElement("div", __assign({ style: { cursor: "grab" }, className: "repeatable-list__drag-handle" }, listeners), children));
