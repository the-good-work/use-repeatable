...
function RepeatableList(_a) {
    ...
    return (react_1.default.createElement(Layout, { items: items, addItem: addItem, removeItem: removeItem, moveItem: moveItem, updateItem: updateItem, AddButton: function (_a) {
            var onClick = _a.onClick, children = _a.children, index = _a.index, newItem = _a.newItem;
            return (react_1.default.createElement(AddButton_1.AddButton, { onClick: onClick, children: children, addItem: addItem, index: index, newItem: newItem, length: items.length }));
            ...
            react_1.default.createElement(sortable_1.SortableContext, { items: items, strategy: sortable_1.verticalListSortingStrategy }, items.map(function (item, n) { return (react_1.default.createElement(SortableCard, { key: item.id, id: item.id, Card: Card, cardProps: {
                    ...
                    RemoveButton: function (_a) {
                        var onClick = _a.onClick, children = _a.children, index = _a.index;
                        return (react_1.default.createElement(RemoveButton_1.RemoveButton, { onClick: onClick, children: children, removeItem: removeItem, index: index || n }));
                    },
                    MoveButton: function (_a) {
                        var onClick = _a.onClick, children = _a.children, direction = _a.direction;
                        return (react_1.default.createElement(MoveButton_1.MoveButton, { direction: direction, onClick: onClick, children: children, moveItem: moveItem, index: n, length: items.length }));
                    },
                } })); })))); } }));
}
