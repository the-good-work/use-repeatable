...
function RepeatableList(_a) {
    ...
    var _b = (0, _1.useRepeatable)({
        ...
        newItem: newItem,
        onChange: onChange,
    }), items = _b.items, addItem = _b.addItem, removeItem = _b.removeItem, moveItem = _b.moveItem;
    ...
    return (react_1.default.createElement(Layout, { addItem: addItem, Cards: function () { return (react_1.default.createElement(core_1.DndContext, { sensors: sensors, collisionDetection: core_1.closestCenter, onDragEnd: handleDragEnd },
            react_1.default.createElement(sortable_1.SortableContext, { items: items, strategy: sortable_1.verticalListSortingStrategy }, items.map(function (item, n) { return (react_1.default.createElement(SortableCard, { key: item.id, id: item.id, Card: Card, cardProps: {
                    ...
                    items: items,
                    index: n,
                    removeItem: function () { return removeItem(n); },
                    moveItem: moveItem,
                } })); })))); } }));
}
...
function SortableCard(_a) {
    ...
    return (react_1.default.createElement("div", __assign({ ref: setNodeRef }, attributes, { style: { transform: utilities_1.CSS.Transform.toString(transform), transition: transition } }),
        react_1.default.createElement(Card, __assign({}, cardProps, { dragHandleListeners: listeners }))));
}
