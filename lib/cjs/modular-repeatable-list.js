...
function CardComp(_a) {
    var sensors = _a.sensors, handleDragEnd = _a.handleDragEnd, items = _a.items, Card = _a.Card, removeItem = _a.removeItem, moveItem = _a.moveItem, addItem = _a.addItem, updateItem = _a.updateItem, removeAll = _a.removeAll;
    return function () {
